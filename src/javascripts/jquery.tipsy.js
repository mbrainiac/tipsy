...
(function ($) {
    ...
    show: function () {
      ...
      if (title && this.enabled) {
        ...
        var actualWidth = $tip[0].offsetWidth,
            ...
            gravity = this.$element.attr("tooltip-gravity") ? this.$element.attr("tooltip-gravity") : maybeCall(this.options.gravity, this.$element[0]);
        ...
        var topPadding = this.$element.attr("tooltip-padding-top");
        if (topPadding) {
          tp.top += parseInt(topPadding);
        }
  ...
  $.fn.tipsy.auto = function () {
    return $.fn.tipsy.autoBounds2(0, 'sn');
  };
  /**
